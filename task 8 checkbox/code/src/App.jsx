...
const CheckboxList = () => {
	...
	const updateSingleCheckbox=(id)=>{
		const update=checkboxes.map((checkbox)=>
				...
				{checkboxes.map((checkbox, index) => (
					<CheckboxLabel key={checkbox.id}>
						<input
							...
							onChange={()=>updateSingleCheckbox(checkbox.id)}
						/>
						{checkbox.label}
					</CheckboxLabel>
				))}
			</CheckboxContainer>
			<SelectAllButton data-testid="button" onClick={updateCheckbox}>Select All</SelectAllButton>
		</Container>
	)
}
